        ...
        <>
            <div className="flex flex-col px-7">
                <div className="flex items-center text-xs">
                    <div className="flex items-center justify-center w-25 h-7_5 bg-white rounded-md shadow-card">
                        <BsStarFill className="text-c_6E7582"/>
                        <div className="text-c_6E7582 ml-2 font-semibold">Watchlist</div>
                    </div>
                    <div className="flex items-center justify-center w-25 h-7_5 bg-white rounded-md shadow-card ml-2">
                        <BsPieChartFill className="text-c_6E7582"/>
                        <div className="text-c_6E7582 ml-2 font-semibold">Portfolio</div>
                    </div>
                    <div className="flex items-center justify-center w-16 h-7_5 ml-7 bg-c_1564C0 text-white font-semibold rounded-l-full rounded-r-full shadow-card">Top 10</div>
                    <div className="flex items-center justify-center w-25 h-7_5 ml-7 bg-white text-c_6E7582 font-semibold rounded-l-full rounded-r-full shadow-card">Top Gainers</div>
                    <div className="flex items-center justify-center w-25 h-7_5 ml-7 bg-white text-c_6E7582 font-semibold rounded-l-full rounded-r-full shadow-card">Top Loosers</div>
                    <button className="text-c_1564C0 font-semibold ml-auto text-sm">View All</button>
                </div>

                <div className="w-full h-0.5 bg-c_E8EBF1 mt-7_5"></div>

                {/* table part */}
                <div>
                    <div className="flex items-center w-full text-xs text-black font-bold py-4">
                    ...
                    <div className="flex flex-col text-xs">
                        {table_data.map((item, index) => {
                            return <div key={`data_${index}`} className="flex flex-col">
                                        <div className={`flex items-center w-full py-4 ${enableExpand[index] ? 'bg-white' : ''}`}>
                                            <div className="flex items-center w-1/12 pl-5">
                                                <BsStar className="text-c_6E7582"/>
                                                <div className="text-black font-semibold ml-4">{index + 1}</div>
                                            </div>
                                            <div className="flex items-center w-2/12">
                                                <div className="bg-c_E8EBF1 w-6 h-6 rounded-full"></div>
                                                <div className="ml-1 text-black font-semibold">{item.name}</div>
                                                <div className="ml-1 text-c_6E7582">{item.label}</div>
                                                <button className={`w-9 h-5_5 ml-1 flex items-center justify-center text-c_6E7582 font-semibold rounded-md shadow-card ${item.enableBuyBtn ? 'block' : 'hidden'}`}>BUY</button>
                                            </div>
                                            <div className="text-right text-black font-semibold" style={{width: '20%'}}>${item.price}</div>
                                            ...
                                            <div className="flex-1 flex items-center pr-5">
                                                ...
                                                <div className={`w-5 h-5 rounded-full flex flex-col ${enableExpand[index] ? 'bg-c_1564C0' : 'bg-white border border-c_1564C0'}`}>
                                                    <div className="mx-auto my-auto cursor-pointer" 
                                                        ...
                                                        <BsChevronExpand className={`${enableExpand[index] ? 'text-white' : 'text-c_1564C0'}`}/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className={`bg-white ${enableExpand[index] ? 'block': 'hidden'}`}>
                                            <div className="flex items-center w-full py-4 text-xs">
                                                ...
                                                <div className="text-right text-black font-semibold" style={{width: '20%'}}>${item.market_cap}</div>
                                                <div className={`flex items-center justify-center text-c_6E7582 font-semibold`} style={{width: '20%'}}>
                                                    Circulating Supply
                                                </div>
                                                <div className={`w-1/12 flex items-center justify-center text-black font-semibold`} style={{width: '10%'}}>
                                            ...
                                            <div className="flex items-center w-full py-4 text-xs">
                                                ...
                                                <div className="text-right text-black font-semibold" style={{width: '20%'}}>${item.h24_trading_vol}</div>
                                            ...
                                            <div className="flex items-center w-full py-4 text-xs">
                                                ...
                                                <div className="text-right text-black font-semibold" style={{width: '20%'}}>${item.fully_diluted_valuation}</div>
