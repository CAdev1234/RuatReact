...
const NavBar = ({navItems}) => {
    ...
    return (
        <div className="navbar h-full flex flex-col rounded-l-md py-1.5 w-72 text-black dark:text-white bg-white dark:bg-transparent shadow-card dark:shadow-dark_card">
